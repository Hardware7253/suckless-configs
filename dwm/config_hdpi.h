...
static const char *fonts[]          = { "Hack:style=regular:pixelsize=36:antialias=true:autohint=true" };
static const char dmenufont[]       = "Hack:style=regular:pixelsize=36:antialias=true:autohint=true";
