...
static const char *fonts[]          = { "Ubuntu Mono:style=regular:pixelsize=40:antialias=true:autohint=true" };
static const char dmenufont[]       = "Ubuntu Mono:style=regular:pixelsize=40:antialias=true:autohint=true";
